...
namespace transmission {
    ...
    void init() {
        ...
        int port_tr[10] = {2};
        int port_br[10] = {3};
        motor_top_left = motorInit(port_tl, NULL, NULL);
        motor_btm_left = motorInit(port_bl, NULL, NULL);
        motor_top_right = motorInit(port_tr, NULL, NULL);
        motor_btm_right = motorInit(port_br, NULL, NULL);
